...
<div class="w-full max-w-sm bg-white rounded-3xl shadow-xl shadow-blue-100 p-10">
    ...
    <p class="text-sm text-gray-400 mb-8">Masuk untuk kelola kamar kamu</p>
    ...
    <form method="POST" action="/login" class="space-y-4">
        ...
        <div>
            ...
            <div class="relative">
                <input type="email" name="email" placeholder="nama@email.com" required
                    class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 pl-10 text-sm outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-100 transition-all">
        ...
        <div>
            ...
            <div class="relative">
                <input type="password" name="password" id="passwordInput" placeholder="••••••••" required
                    class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 pl-10 pr-10 text-sm outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-100 transition-all">
                ...
                <button type="button" onclick="togglePw()" id="pwBtn"
                    class="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-300 hover:text-blue-400 transition-colors">
        ...
        <button type="submit"
            class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl text-sm transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-200 flex items-center justify-center gap-2 mt-2">
            Masuk
